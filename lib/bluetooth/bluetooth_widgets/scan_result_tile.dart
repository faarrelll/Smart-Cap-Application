...
import 'package:bluetooth_low_energy/bluetooth/bluetooth_utils/snackbar.dart';
      ...
      onPressed: () {
        if (isConnected == true) {
          ...
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => Dashboard(device: widget.result.device),
              ));
        ...
        } else if (widget.result.advertisementData.connectable == true) {
          widget.onTap;
          print('ontap');
          print(widget.onTap);
        } else {
